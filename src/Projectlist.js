...
class Projectlist extends React.Component{
    constructor(props){
      ...
      xhttp.open("GET","https://localhost:4000/get",true);
    ...
    xhttp.send();
     ...
     del(){
		...
		var xhttp = new XMLHttpRequest();
            ...
            xhttp.open("DELETE", "https://localhost:4000/delete", true);
         ...
         edit(){
            ...
            var data = {
                ...
                xhttp.open("PUT", "https://localhost:4000/edit", true);
                xhttp.setRequestHeader("Content-Type", "application/json;charset=UTF-8");
                xhttp.send(JSON.stringify(data));
            }
    ...
    render(){
        return(
            <div className="container-fluid" id="det">
              ...
              <input type="time" className="form-control w-50" id="jan" placeholder="start time"required/>
             <input type="time" className="form-control w-50 display ml-4" id="feb" placeholder="end time"required/>
             </div>  
