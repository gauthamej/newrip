            ...
            <div className="row ">   
                ...
                <div className="col-8">
                    ...
                    <form onSubmit={this.submit} >                   
                      ...
                      <label className="details"> PHONE NUMBER:</label><input type="number" className="form-control w-50" maxlength="10" id="number" placeholder="number"required/><br/>
                        ...
                        <input type="time" className="form-control w-50" id="estart" maxlength="2" placeholder="start time"required/>
                        <input type="time" className="form-control w-50 display ml-4" id="eend" maxlength="2" placeholder="end time"required/>
